...
const Home = () => {
 ...
 <h1 className="text-6xl font-bold mb-3 text-gray-800 hover:scale-105 transition-transform duration-200 ease-in-out">
 Your resume, Reimagined.
 </h1>
 <p className="text-lg text-gray-600 mb-8 hover:scale-105 transition-transform duration-200 ease-in-out">
 ...
 disabled={loading}
 className="px-6 py-3 bg-gray-200 text-gray-800 font-semibold rounded hover:bg-gray-300 disabled:opacity-50 hover:scale-105 transition-transform duration-200 ease-in-out"
 >
 {loading ? "Analyzing..." : "Analyze My Resume"}
 </button>
 {error && (
 <p className="text-red-400 mt-4 hover:scale-105 transition-transform duration-200 ease-in-out">
 {error}
 </p>
 )}
 </section>
 ...
 <h2 className="text-3xl font-bold text-center mb-10 text-gray-800 hover:scale-105 transition-transform duration-200 ease-in-out">
 How it works ?
 </h2>
 ...
 {[
 "What are the benefits of using a resume analyzer ?",
 "What features does the resume analyzer offer ?",
 "Is the resume analyzer free to use ?",
 "How can I support if I have questions ?",
 ].map((q, i) => (
 <details
 key={i}
 ...
 This is a sample answer. You can replace it with the actual response later.
 </p>
 </details>
 ))}
 </div>
